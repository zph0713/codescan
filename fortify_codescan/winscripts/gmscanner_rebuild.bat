...
SET ProjectWorkspace="%WorkingRoot%workspace\xxx\CAS-codescan\cas-fortify\dev\cas-xxx\src\xxx\buildall.sln"
SET ProjectWorkspaceT="D:\ci-jenkins\workspace\xxx\CAS-codescan\cas-fortify\dev\cas-xxx\src\xxx\buildall.sln"
